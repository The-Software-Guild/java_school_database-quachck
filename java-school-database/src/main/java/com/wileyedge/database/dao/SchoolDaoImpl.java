...
public class SchoolDaoImpl implements SchoolDao {
	...
	/*
	 * Add each SQL statement to the methods below. The SQL statement must be
	 * completely inside the quotation marks provided in the existing Java
	 * statement: String sql = "";
	 *
	 * Special notes: - Strings must be inside single quotation marks (' '). -
	 * Strings are case-sensitive. - Semi-colons are optional at the end of the SQL
	 * statement.
	 *
	...
	public List<Course> csCourses() {
		...
		String sql = "SELECT course.courseCode, course.courseDesc " + "FROM course "
				+ "JOIN teacher ON course.teacherId = teacher.teacherId " + "WHERE teacher.dept = 'Computer Science'";
	...
	public List<StudentClassCount> studentsPerClass() {
		...
		String sql = "SELECT courseCode, courseDesc, COUNT(*) as numStudents " + "FROM course "
				+ "JOIN course_student ON course.cid = course_student.course_id "
	...
	public void addStudentToClass() {
		...
		String sql = "INSERT INTO course_student (student_id, course_id) " + "VALUES (10, 1)";
